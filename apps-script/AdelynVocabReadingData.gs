/**
 * Data for seedAdelynVocabReading_() — see AdelynVocabReadingSeed.gs.
 * This file intentionally holds ONLY data (no functions) — it's large
 * (300KB+), and the Apps Script editor's function dropdown doesn't index
 * functions reliably in files this size. Nothing in here needs to be run
 * directly.
 */
